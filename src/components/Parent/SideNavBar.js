    ...
    return (
            ...
            >
                <Toolbar style={{ backgroundColor: "white", justifyContent: 'space-between' }}>
                    ...
                    <Menu
                        ...
                        onClose={handleClose}
                    >
                        <MenuItem onClick={() => { handleRoute('/parent/profile'); handleClose() }}>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;Logout</MenuItem>
            ...
            >
                ...
                >
                    <ListItem button key="Dashboard" onClick={() => { handleRoute('/parent/'); handleAll() }} >
                    ...
                    <Collapse in={openComplaint} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItem button key="AddComplaint" onClick={() => { handleRoute('/parent/Complaint/add'); handleAll() }} className={classes.nested}>
                                <ListItemIcon>
                                    <StarBorder />
                                </ListItemIcon>
                                <ListItemText primary="Add" />
                            </ListItem>
                            <ListItem button key="ViewComplaint" onClick={() => { handleRoute('/parent/Complaint/view'); handleAll() }} className={classes.nested}>
                                <ListItemIcon>
                                    <StarBorder />
                                </ListItemIcon>
                    ...
                    <ListItem button key="Class Schdule" onClick={() => { handleRoute('/parent/ClassSchdule/view'); handleAll() }}>
                    ...
                    <ListItem button key="Student Attendance" onClick={() => { handleRoute('/parent/Attendance/view'); handleAll() }}>
                    ...
                    <ListItem button key="Enrolled Courses" onClick={() => { handleRoute('/parent/Enrolled'); handleAll() }}>
                    ...
                    <ListItem button key="View Announcement" onClick={() => { handleRoute('/parent/announcement'); handleAll() }}>
                    ...
                    <ListItem button key="Student Result" onClick={() => { handleRoute('/parent/result'); handleAll() }}>
