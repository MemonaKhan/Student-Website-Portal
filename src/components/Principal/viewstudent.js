...
const Viewstudent = (props) => {
  ...
  const handleEdit = () =>{
    history.push('/principal/student/edit');
  ...
  const data = {
    ...
    rows: [
      { 
        ...
        Name: 'mike',
        image: <img height="50%" width="25%" alt={Image} />,
        address: 'D-17 near ---.',
  ...
  return (
    <div style={{ backgroundColor: 'white', padding: '10%', boxShadow: '0 0 5px 2px #C0C0C0' }}>
      <div style={{ textAlign: 'center' }}><h2>student View</h2></div>
      <Divider /><br />
