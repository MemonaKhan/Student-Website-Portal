...
export class addcourseassign extends Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        return (
                ...
                <div style={{ padding: '5%', boxShadow: '0 0 5px 2px #C0C0C0', backgroundColor: 'white', fontFamily: 'Times New Roman' }}>
                    <div style={{ textAlign: 'center' }}><h2>course Assign</h2></div>
                    <Divider /><br />
                    <Form>
                        <Form.Group controlId="teacher">
                            ...
                            <Form.Control as="select" required>
                                ...
                                <option>Mr.jamil</option>
                                <option>prof.savash</option>
                            </Form.Control>
                        </Form.Group>
                        <Form.Group controlId="course Title">
...
export default addcourseassign;