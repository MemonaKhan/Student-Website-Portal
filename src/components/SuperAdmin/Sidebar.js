                ...
                >
                    ...
                    <Collapse in={openArticle} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItem button key="AddArticle" onClick={() => {handleRoute('/article/add');handleAll()}} className={classes.nested}>
                                <ListItemIcon>
                                    <StarBorder />
                                </ListItemIcon>
                                <ListItemText primary="Add" />
                            </ListItem>
                            <ListItem button key="ViewArticle" onClick={() => {handleRoute('/article/view');handleAll()}} className={classes.nested}>
                                <ListItemIcon>
                                    <StarBorder />
                                </ListItemIcon>
                    ...
                    <ListItem button key="Discussion" onClick={() => {handleRoute('/discussion');handleAll()}}>
                    ...
                    <ListItem button key="Result" onClick={() => {handleRoute('/result');handleAll()}}>
