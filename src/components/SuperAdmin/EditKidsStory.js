...
export class EditKidsStory extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <>
                <div style={{ padding: '5%', boxShadow: '0 0 5px 2px #C0C0C0', backgroundColor: 'white', fontFamily: 'Times New Roman' }}>
                    <div style={{ textAlign: 'center' }}><h2>Kids Story Form</h2></div>
                    <Divider /><br />
                    <Form>
                        <Form.Group controlId="storyType">
                            <Form.Label>Kids Story Type</Form.Label>
                            <Form.Control as="select" required>
                                <option>-- Select Kids Story Type --</option>
                        ...
                        <Form.Group>
                            <Form.File id="storyImage" label="Image" />
                        </Form.Group>
                        <Form.Group controlId="storyShortDesc">
                            <Form.Label>Short Description</Form.Label>
                            <Form.Control as="textarea" rows={3} placeholder="Enter Short Description" required />
                        </Form.Group>
                        <Form.Group controlId="storyLongDesc">
