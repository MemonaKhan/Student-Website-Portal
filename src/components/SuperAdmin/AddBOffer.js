...
export class AddBOffer extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <>
                <div style={{ padding: '5%', boxShadow: '0 0 5px 2px #C0C0C0', backgroundColor: 'white', fontFamily: 'Times New Roman' }}>
                    <div style={{ textAlign: 'center' }}><h2>HINDU RELIGIOUS FORM</h2></div>
                    <Divider /><br />
                    <Form>
                        <Form.Group controlId="offerType">
                            <Form.Label>Business Offer Type</Form.Label>
                            <Form.Control as="select" required>
                                <option>-- Select Business Offer Type --</option>
